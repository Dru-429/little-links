...
const Navbar = () => {
  return (
    <div className="md:w-[85%] w-[95%] flex items-center justify-between py-2 px-1 md:px-7 py-1md:py-2 box-border backdrop-blur-md bg-accent/80 rounded-3xl p-8 border border-accent/90 shadow-2xl md:mt-4 mt-2">
